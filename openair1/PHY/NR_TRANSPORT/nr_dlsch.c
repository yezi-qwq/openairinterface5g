...
dmrs_case1(c16_t *txF, c16_t *mod_dmrs, const int amp_dmrs, int sz, int start_sc, int upper_limit, int remaining_re)
{
  ...
  if ((i << 3) != (sz)) {
    for (int i2 = i << 2, j2 = j << 2; i2 < (sz) >> 1; i2++) {
  ...
  if ((i << 5) != (sz)) {
    for (int i2 = i << 4, j2 = j << 4; i2 < (sz) >> 1; i2++) {
      dmrs_mux[j2].r = (((mod_dmrs[i2].r * amp_dmrs) >> 14) + 1) >> 1;
      dmrs_mux[j2].i = (((mod_dmrs[i2].i * amp_dmrs) >> 14) + 1) >> 1;
      j2++;
      dmrs_mux[j2].r = 0;
  ...
  if ((i << 4) != (sz)) {
    for (int i2 = i << 3, j2 = j << 3; i2 < (sz) >> 1; i2++) {
      dmrs_mux[j2].r = (((mod_dmrs[i2].r * amp_dmrs) >> 14) + 1) >> 1;
      dmrs_mux[j2].i = (((mod_dmrs[i2].i * amp_dmrs) >> 14) + 1) >> 1;
      j2++;
      dmrs_mux[j2].r = 0;
...
dmrs_case2(c16_t *txF, c16_t *mod_dmrs, const int amp_dmrs, int sz, int start_sc, int upper_limit, int remaining_re)
{
  ...
  if ((i << 3) != (sz)) {
    for (int i2 = i << 2, j2 = j << 2; i2 < (sz) >> 1; i2 += 2) {
      dmrs_mux[j2].r = (((mod_dmrs[i2].r * amp_dmrs) >> 14) + 1) >> 1;
      dmrs_mux[j2].i = (((mod_dmrs[i2].i * amp_dmrs) >> 14) + 1) >> 1;
      j2++;
      dmrs_mux[j2].r = 0;
  ...
  if ((i << 4) != (sz)) {
    for (int i2 = i << 3, j2 = j << 3; i2 < (sz) >> 1; i2 += 2) {
      dmrs_mux[j2].r = (((mod_dmrs[i2].r * amp_dmrs) >> 14) + 1) >> 1;
      dmrs_mux[j2].i = (((mod_dmrs[i2].i * amp_dmrs) >> 14) + 1) >> 1;
      j2++;
      dmrs_mux[j2].r = 0;
...
dmrs_case4(c16_t *txF, c16_t *mod_dmrs, const int amp_dmrs, int sz, int start_sc, int upper_limit, int remaining_re)
{
  ...
  if ((i << 5) != (sz)) {
    for (int i2 = i << 4, j2 = j << 4; i2 < (sz) >> 1; i2 += 2) {
      dmrs_mux[j2].r = 0;
      dmrs_mux[j2].i = 0;
      j2++;
      dmrs_mux[j2].r = (((mod_dmrs[i2].r * amp_dmrs) >> 14) + 1) >> 1;
                              ...
                              int remaining_re)
{
  ...
  if ((i << 3) != (sz)) {
    for (int i2 = i << 2, j2 = j << 3; i2 < (sz) >> 1; i2++) {
      dmrs_mux[j2].r = (((txlc[i2].r * amp) >> 14) + 1) >> 1;
      dmrs_mux[j2].i = (((txlc[i2].i * amp) >> 14) + 1) >> 1;
      j2++;
      dmrs_mux[j2].r = (((mod_dmrs[i2].r * amp_dmrs) >> 14) + 1) >> 1;
                              ...
                              int remaining_re)
{
  ...
  if ((i << 3) != (sz)) {
    for (int i2 = i << 2, j2 = j << 3; i2 < (sz) >> 1; i2 += 2) {
      dmrs_mux[j2].r = (((txlc[i2].r * amp) >> 14) + 1) >> 1;
      dmrs_mux[j2].i = (((txlc[i2].i * amp) >> 14) + 1) >> 1;
      j2++;
      dmrs_mux[j2].r = (((mod_dmrs[i2].r * amp_dmrs) >> 14) + 1) >> 1;
